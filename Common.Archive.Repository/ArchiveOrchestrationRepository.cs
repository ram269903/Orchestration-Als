...
{
    public class ArchiveOrchestrationRepository : IArchiveOrchestrationService
    {
        ...
        private List<IDataParameter> TakeGenerateLog(GenerateLog log)
        {
            ...
            var parameters = new List<IDataParameter>
            {
                ...
                QueryHelper.CreateSqlParameter("@opening_balance",log.LoanType,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@ending_balance",log.LoanAmount,SqlDbType.NVarChar),
        ...
        public async Task<GenerateLog> SaveArsRecordMetaData(GenerateLog generateLog,string productName)
        {
            try
            {
                string sql = $@" INSERT INTO [dbo].[ccss_ars_metadata_ln]
                                        ([id],
                                         [cycle_id],
                                         [statement_date],
										 [product_name],
                ...
                Log.Error(ex,"Error while inserting record into metadata "+generateLog.Id);
                return null;
            }
        }
        ...
        private List<IDataParameter> TakeMetaData(GenerateLog log)
        {
            ...
            var parameters = new List<IDataParameter>
            {
                ...
                QueryHelper.CreateSqlParameter("@product_type",log.ProductType,SqlDbType.NVarChar),
                ...
                QueryHelper.CreateSqlParameter("@account_number",log.AccountNumber,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@file_name",log.FileName,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@division_code",log.DivisionCode,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@cis_number",log.CISNumber,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@dob",log.DOB,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@id_number",log.IdNumber,SqlDbType.NVarChar),
                ...
                QueryHelper.CreateSqlParameter("@productDesc",log.ProductDescription,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@badIndicator",log.BadIndicator,SqlDbType.NVarChar),
            };
        ...
        public async Task<SuppressionReport> SaveSuppressionRecord(SuppressionReport suppressionReport) {
            ...
            string sql = $@"INSERT INTO [dbo].[ccss_suppression_report] 
                                        ( [id], 
                                          [cycle_id], 
                                          [statement_date], 
                                          [account_number], 
        ...
        private List<IDataParameter> TakeSuppressionReport(SuppressionReport suppressionReport)
        {
            ...
            var parameters = new List<IDataParameter>
            {
                ...
                //QueryHelper.CreateSqlParameter("@filename",suppressionReport.FileName,SqlDbType.NVarChar),
                QueryHelper.CreateSqlParameter("@description",suppressionReport.Description,SqlDbType.NVarChar),

...
using Common.ExpressionBuilder.Configuration;
using Common.ExpressionBuilder.Exceptions;
using Common.ExpressionBuilder.Interfaces;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Common.ExpressionBuilder.Helpers
{
    /// <summary>
